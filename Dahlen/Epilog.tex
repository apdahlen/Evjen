...
% Something is missing here along the lines of never let the wound heal. There must forever be people to step into Evjens position and question the workings of the church.


% FIXME: The wound must remain tender. There must always be men and women willing to step into Evjen’s place and trouble the church with its own confession. Not every critic is faithful, and not every wound is holy. Yet a church that can no longer endure the question has already begun to trade living confession for institutional peace. The Principles are not preserved by avoiding the wound, but by returning to it under the Word of God.
