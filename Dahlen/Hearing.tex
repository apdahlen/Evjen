...
\item Ecclesiology: The ship is the visible and bounded form of the congregation.

\item Dogmatics and Ecclesiology: The word is preached clearly so that all hands can point the way from old Adam to the promise on the Cross. 
...
\item Polity: They learn about each other over coffee and cookies. This is not an optional exercise as it is the primary way that member of the congregation get to know each other. The resulting prayers are real as the crew cares enough to hear how others are suffering.    
...
\item Ecclesiology: There are many ships of many designs. All have a mission.
...
\item Dogmatics: This is not a healthy ship. We are all sinners, Satan is whispering to the crew, and the real world presses in with political, societal, and economic constraints. There are also openly hostile enemies to Christianity. 
