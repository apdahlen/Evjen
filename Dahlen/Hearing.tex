...
\item Dogmatics: The ship is a gift from Christ originating in Pentecost in the upper room.
...
\item Dogmatics: The ship is powered by the Word and sacraments. All crewmembers are marked with the cross at baptism. The crew kneels for the body and blood of Christ given and shed for you.

\item Polity: They learn about each other over coffee and cookies. This is not an optional exercise as it is the primary way that member of the congregation get to know each other.    

\item Dogmatics: Justification was purchased at the cross. Sanctification is the Spirit's work. In the Reformation tradition, we acknowledge that faith alone justifies, but faith is never alone. We fear a passive crew.

\item Ecclesiology: Being a member of the crew in no way implies that we are saved. This is not works-righteousness; you will not be saved by working harder, longer, or by advancing in station aboard the ship. However, in the same breath, you are called to work "as far as its abilities and power permit." 
