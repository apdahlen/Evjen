...
Let's begin with a quote from John Evjen that appeared in a 1930s book on Lutheranism, "It was my good fortune to come to Augsburg College and Theological Seminary, Minneapolis, headed by the greatest theologian that America has ever had, Professor George Sverdrup [SIC]...Augsburg taught spirited Lutheranism to a high degree. After completing seven years in this institution..."\footnote{John O. Evjen, ``What Is Lutheranism?'' in \textit{What Is Lutheranism? A Symposium in Interpretation}, ed. Vergilius Ferm (New York: The Macmillan Company, 1930), 9.}
...
Vocation is also ecclesial, not merely individual, a point developed later through the sailor's model. This is the clarity passed down from Sverdrup and Oftedal. P1 demands nothing less than all God's gifts by all hands within the congregation. This is the visible congregation manifesting spirit and life. The struggle for a clear definition of congregation is an uncomfortable gift that John Evjen has given the AFLC. With an engineer's mind he stress-tests the Fundamental Principles starting with the first:
...
This work serves to breathe life into the Principles. P1 is not presented as a clean description but as a spoken confession held upright in tension. 

Evjen is necessary to reveal the foundations of the AFLC.
