...
This is not a biography of Evjen, Sverdrup, or Oftedal. Nor is it a history of the AFLC. However, Evjen's works from 1910 to 1918 are still with us today. Together, the six sections ask if the AFLC principles still serve as the foundation for living congregations or if ``spirit and life'' has become a slogan.   
...
Note that \textit{Guidance} contains no commentary by Evjen---not even a foreword explaining why these particular writings were selected. The inclusion of Oftedal's Hennepin County affidavit is also puzzling. From ``The Position,'' we learn that Evjen used \textit{Guidance} as a textbook while teaching at seminary. For example, the affidavit shows that Sverdrup and Oftedal were anchored in the American free-church current of their time:\footnote{Installment 4: “Folkebladet” April 3, 1918}
